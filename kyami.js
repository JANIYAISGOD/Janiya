...
const isCreator = (m && m?.sender && [botNumber, ...global.owner].map(v => v.replace(/[^0-9]/g, '') + '2349052076139@s.whatsapp.net').includes(m?.sender)) || false;
const isRegistered ="checkRegisteredUser(m.sender)"
const itsMe = (m && m?.sender && m?.sender == botNumber) || false;
const text = q = args.join("𝙳𝙰𝚁𝙺-𝙰𝙽𝙶𝙴𝙻-𝙼𝙳 𝚒𝚜 𝚌𝚘𝚗𝚗𝚎𝚌𝚝𝚎𝚍");
...
item2.EMAIL;type=INTERNET:Kyami@gmail.com\n
...
//================== [ DATABASE ] ==================//
const totalFitur = () =>{
var mytext = fs.readFileSync("./kyami.js").toString()
...
let { key } = await kyami.sendMessage(m.chat, {text: '_Loading_'})//Pengalih Isu

for (let i = 0; i < loadd.length; i++) {
await kyami.sendMessage(m.chat, {text: loadd[i], edit: key })}
}
//================== [ FUNC BANCHAT ] ==================//
...
if (db.data.settings[botNumber].autoread) { kyami.readMessages([m?.key]) }

if (db.data.chats[m?.chat].antilink) {
if (budy.match(`https://whatsapp.com/channel/0029VamzCT5GzzKRylqvj33l`)) {
kyami.sendMessage(m?.chat, {react: {text: `❌️`,key: m?.key,}})
if (!isBotAdmins) return
let gclink = (`https://whatsapp.com/channel/0029VamzCT5GzzKRylqvj33l` + await kyami.groupInviteCode(m?.chat))
let isLinkThisGc = new RegExp(gclink, 'https://whatsapp.com/channel/0029VamzCT5GzzKRylqvj33l')
...
let isgclink = isLinkThisGc.test(m?.text)
if (isgclink && isOwner && isAdmins) return
kyami.sendMessage(m?.chat, { delete: m?.key })
}}
...
let ceknye = await kyami.onWhatsApp(bnnd)
...
teks = '*Premium List*\n\n'
for (let kyami of premium) {
teks += `- ${kyami}\n`
}
teks += `\n*Total : ${premium.length}*`
kyami.sendMessage(m.chat, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": premium } })
break
...
teks += `\n*Total : ${owner.length}*`
kyami.sendMessage(m.chat, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": owner } })
break
case 'kyami':
case 'owner': case 'creator': {
await kyami.sendContact(m.chat, owner.map( i => i.split("@")[0]), m)
kyami.sendMessage(m.chat, {audio: fs.readFileSync('./media/pakyami12.mp3'), mimetype:'audio/mpeg', ptt: true}, {quoted: m})     
}
break
case "tes": case "bot":{
...
ɪ ᴀᴍ *𝙳𝙰𝚁𝙺-𝙰𝙽𝙶𝙴𝙻-𝙼𝙳* ᴀᴜᴛᴏᴍᴀᴛᴇᴅ ꜱyꜱᴛᴇᴍ (ᴡʜᴀᴛꜱᴀᴩᴩ ʙᴏᴛ) ᴛʜᴀᴛ ᴄᴀɴ ʜᴇʟᴩ ᴛᴏ ᴅᴏ ꜱᴏᴍᴇᴛʜɪɴɢ, ꜱᴇᴀʀᴄʜ ᴀɴᴅ ɢᴇᴛ ᴅᴀᴛᴀ / ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ᴏɴʟy ᴛʜʀᴏᴜɢʜ ᴡʜᴀᴛꜱᴀᴩᴩ
...
⭔ *𝙎𝙩𝙖𝙩𝙪𝙨 :* *${isOwner ? "𝐎𝐧𝐥𝐢𝐧𝐞" : "User ⭐"}*
⭔ *𝙋𝙧𝙚𝙢𝙞𝙪𝙢 :* *${isPremium ? "✅" : "❎"}*

[ _*𝐈 𝐍 𝐅 𝐎 - 𝐁 𝐎 𝐓*_ ] 
⭔ *𝘽𝙤𝙩 𝙉𝙖𝙢𝙚 :* 𝐃𝐀𝐑𝐊 𝐀𝐍𝐆𝐄𝐋 𝐌𝐃
⭔ *𝙏𝙮𝙥𝙚 :* 𝙼𝚄𝙻𝚃𝙸 𝙳𝙴𝚅𝙸𝙲𝙴 𝙱𝙾𝚃
⭔ *𝙑𝙚𝙧𝙨𝙞𝙤𝙣 :* 1.0.0
...
await kyami.sendMessage(men, { image: { url: mem }, caption: global.tekspushkonv2 })
} else {
await kyami.sendMessage(men, { text: global.tekspushkonv2 })
}
}
kyami.sendMessage("@s.whatsapp.net", {text:`🕊️ Sukses Bang...`})
}
break
///
case "promote":{
...
await kyami.sendMessage(m.chat, { audio: bangzyeekull, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
break
////
case 'pokemon': {
...
kyami.sendMessage(m.chat, { text: message }, 'extendedTextMessage', { quoted: m });
...
break;
        ...
        case 'getdb': {
            ...
            kyami.sendMessage(m.chat, { document: sesi, mimetype: 'application/json', fileName: 'database.json' }, { quoted: m })
            }
        break
        ////////////
case 'gc': { 
...
if (!isBotAdmins) return m.reply(mess.botAdmin)
if (args[0] === 'close'){
await kyami.groupSettingUpdate(m.chat, 'announcement').then((res) => m?.reply(`Sukses Menutup Group`)).catch((err) => m?.reply(jsonformat(err)))
} else if (args[0] === 'open'){
await kyami.groupSettingUpdate(m.chat, 'not_announcement').then((res) => m?.reply(`Sukses Membuka Group`)).catch((err) => m?.reply(jsonformat(err)))
} else {
...
await kyami.groupAcceptInvite(result).then((res) => m?.reply(jsonformat(res))).catch((err) => m?.reply(jsonformat(err)))
}
break
//=================================================//
case 'leave': {
if (!isOwner) return m?.reply(mess.owner)
m?.reply("Aku Pergi :v")
await kyami.groupLeave(m?.chat).then((res) => m?.reply(jsonformat(res))).catch((err) => m?.reply(jsonformat(err)))
}
break
//=================================================//
case 'ht': {
...
kyami.sendMessage(from, { text : q ? q : '' , mentions: participants.map(a => a.id)}, {quoted:m})
}
break
//=================================================//
case 'editsubjek': {
...
await kyami.groupUpdateSubject(m.chat, text).then((res)).catch((err) => m?.reply(jsonformat(err)))
}
break
//=================================================//
case 'editdesk':{
...
if (!isBotAdmins) return m.reply(mess.botAdmin)
if (!text) return m?.reply('Text Nya ?')
await kyami.groupUpdateDescription(m.chat, text).then((res)).catch((err) => m?.reply(jsonformat(err)))
}
break
//=================================================//
case 'tagall': {
...
kyami.sendMessage(m?.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted:m })
}
break
//=================================================//
case 'antilink': {
...
if (mediaType === 'video') {
kyami.sendMessage(m?.chat, { video: { url: res.result.media} , caption: res.result.title }, { quoted: m })
} else if (mediaType === 'image') {
kyami.sendMessage(m?.chat, { image: { url: res.result.media}, caption: res.result.title }, { quoted: m })
} else {
...
kyami.sendMessage(m?.chat,{image: {url:getRandom(res)}, caption: "Done"},{quoted:m})
}
break;
//=================================================//
case "chocolate-cake":
...
case "pencil":
case "glitch":{
if (!text) return m.reply(`Ex : ${prefix + command} DarkTaka`)
await loading()
kyami.sendMessage(m?.chat,{image: {url: `https://dsgner.vercel.app/api/textpro/${command}?text=${text}`}, caption: "Done"},{quoted:m})
}
break;
//=================================================//
case "marvel-studios":
...
case "porn-hub":{
let t = text.split('|');
if (t.length < 2) return m.reply(`Ex : ${prefix + command} DarkTaka`);
let text1 = t[0];
let text2 = t[1];
await loading()
kyami.sendMessage(m?.chat,{image: {url: `https://dsgner.vercel.app/api/textpro/${command}?text=${text1}&text2=${text2}`}, caption: "Done"},{quoted:m})
}
break;
//=================================================//
case "sweet-candy":
...
if (!text) return m.reply(`Ex : ${prefix + command} DarkTaka`)
await loading()
kyami.sendMessage(m?.chat,{image: {url: `https://dsgner.vercel.app/api/photooxy/${command}?text=${text}`}, caption: "Done"},{quoted:m})
}
break;
//=================================================//
case 'backup':
...
case 'sewabot':
case 'sewa':
m.reply(`✨ *_Harga Sewa 𝙳𝙰𝚁𝙺-𝙰𝙽𝙶𝙴𝙻-𝙼𝙳_*
❃ Minggu 5k / Group
...
await kyami.sendFile(m.chat, urls[i], 'file', `${i + 1}/${totalCount}`, m);
}
} else {
...
const { data } = await axios.post("https://allvideodownloader.cc/wp-json/aio-dl/video-data/", { url: text });
await kyami.sendMessage(m?.chat, { video: { url: data.medias[0].url }, caption: "done", fileName: `tiktok.mp4`, mimetype: 'video/mp4' })
}
break;
//=================================================//
case "ttslide":{
...
await kyami.sendMessage(m.chat, { image: { url: urls[i] }, caption: `(${i + 1}/${totalCount})` }, { quoted: m });
}} else {
...
for (let i of anu) {
kyami.sendMessage(i, {text: `${text}`}, {quoted:m})
    }
...
kyami.sendMessage(m?.chat, { video: { url: res.result.no_watermark }, caption: res.result.title, fileName: `tiktok.mp4`, mimetype: 'video/mp4' }).then(() => {
kyami.sendMessage(m?.chat, { audio: { url: res.result.music }, fileName: `tiktok.mp3`, mimetype: 'audio/mp4' })
})
}
break;
//=================================================/
...
kyami.sendMessage(m.chat, { video: { url: data.nowm }}, { quoted: m })
})
}
break
//=================================================//
...
kyami.sendMessage(m?.chat,{image: krt.result, caption: "Done"},{quoted:m})
}
break
//=================================================//
case "kalkulator":{
...
kyami.sendMessage(m?.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
fs.unlinkSync(ran)
})
...
if (data.img) return kyami.sendMessage(m?.chat, { image: data.img, caption: data.desc }, { quoted: m })
...
kyami.sendMessage(m?.chat, { audio: Buffer.from(a.audioUrl.split("base64,")[1],"base64"), mimetype: "audio/mpeg" })
}
break
//=================================================//
case 'hd':
...
await loading()
let ppnyauser = await await kyami.profilePictureUrl(m?.sender, 'image').catch(_=> '')
const rest = await quote(text, pushname, ppnyauser)
kyami.sendImageAsSticker(m?.chat, rest.result, m, { packname: `${global.packname}`, author: `${global.author}`})
}
break
//=================================================//
case 'sticker':
...
let FaTiH = await kyami.sendImageAsSticker(m?.chat, smeme, m, { packname: global.packname, author: global.auhor })
...
let encmedia = await kyami.sendImageAsSticker(m?.chat, media, m, { packname: teks1, author: teks2 })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return m?.reply('Maksimal 10 detik!')
let media = await kyami.downloadMediaMessage(qmsg)
let encmedia = await kyami.sendVideoAsSticker(m?.chat, media, m, { packname: teks1, author: teks2 })
await fs.unlinkSync(encmedia)
} else {
return m?.reply(`Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`)
}
...
kyami.sendMessage(m?.chat, { image: { url: imagesUrls[i] }, caption: `Image *(${i + 1}/${totalCount})*\n\nRemaining Credits: ${credits}\nPrompt: ${text}` }, { quoted: m });
} catch (error) {
...
fs.unlinkSync(filePath)
    ...
    try {
        ...
        m.reply(text)
        if (res) {
await kyami.sendMessage(m.chat, { audio: res, ptt: true, mimetype: "audio/mpeg", fileName: "vn.mp3", waveform: [100, 0, 100, 0, 100, 0, 100] }, { quoted: m });
        }
    }
};
break
...
kyami.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By Dark.mp3`}, { quoted : m })
}
break
////////
case "ping":
...
requestFrom: '2349052076139@s.whatsapp.net',
noteMessage: {
extendedTextMessage: {
text: respon,
contextInfo: {
...
case "runtime": {
const tek = `*Hello* @${m?.sender.split('@')[0]}
_*𝙳𝙰𝚁𝙺-𝙰𝙽𝙶𝙴𝙻-𝙼𝙳 Aktif Selama ${runtime(process.uptime())}*_
`
kyami.sendMessage(m?.chat, {
...
}, { quoted: { key: { participant: '2349052076139@s.whatsapp.net', remoteJid: "2349052076139@s.whatsapp.net" }, message: { conversation: global.foter4}}});
}
break
case 'sc':
case 'script': {
await loading()
let buy = `▧ 「 *Script - 𝙳𝙰𝚁𝙺-𝙰𝙽𝙶𝙴𝙻-𝙼𝙳* 」
│
│ ∘ Buy? 2349052076139
│
╰──────────────━`
...
const tek = `*Hello* @${m?.sender.split('@')[0]}
*Bot Ini Di Perkembang Oleh Dark Taka*
...
case 'totalfitur':
case 'totalfeature':{
m.reply(`_*Total Feature 𝙳𝙰𝚁𝙺-𝙰𝙽𝙶𝙴𝙻-𝙼𝙳 Adalah :*_ ${totalFitur()}`)
}
break
...
let regex1 = /(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i
    ...
    kyami.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) =>(mess.error))
break
case 'tourl': {
m.reply(mess.wait)
...
kyami.sendMessage(from, { image: buffer }, {quoted:m})
fs.unlinkSync(ran)
})
}
break
...
newsletterJid: '120363279451240749@newsletter',
serverMessageId: null,
newsletterName: "𝙳𝙰𝚁𝙺-𝙰𝙽𝙶𝙴𝙻-𝙼𝙳"
}
}
}, { quoted: { key: { participant: '2349052076139@s.whatsapp.net', remoteJid: "2349052076139@s.whatsapp.net" }, message: { conversation: "𝙳𝙰𝚁𝙺-𝙰𝙽𝙶𝙴𝙻-𝙼𝙳"}}})
user.pc = new Date() * 1;
}
}
} catch (err) {
kyami.sendMessage('2349052076139@s.whatsapp.net', { text: util.format(err) })
}
}
